...
from Amtrak_Rohit_Divate._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from Amtrak_Rohit_Divate._base_client import (
    DEFAULT_TIMEOUT,
...
class TestAmtrak:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "Amtrak_Rohit_Divate/_legacy_response.py",
                        "Amtrak_Rohit_Divate/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "Amtrak_Rohit_Divate/_compat.py",
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.get("/stations").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            self.client.get("/stations", cast_to=httpx.Response, options={"headers": {RAW_RESPONSE_HEADER: "stream"}})
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.get("/stations").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.get("/stations").mock(side_effect=retry_handler)
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.list_stations.with_raw_response.list_stations(extra_headers={"x-stainless-retry-count": "42"})
...
class TestAsyncAmtrak:
    ...
    async def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        ...
        with pytest.raises(APITimeoutError):
            await self.client.get(
                "/stations", cast_to=httpx.Response, options={"headers": {RAW_RESPONSE_HEADER: "stream"}}
            )
    ...
    async def test_retries_taken(
        ...
        response = await client.list_stations.with_raw_response.list_stations()
    ...
    def test_get_platform(self) -> None:
        ...
        from Amtrak_Rohit_Divate._utils import asyncify
        from Amtrak_Rohit_Divate._base_client import get_platform 
