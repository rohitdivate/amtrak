...
class TestListStations:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_list_stations(self, client: AmtrakRohitDivate) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_list_stations_with_all_params(self, client: AmtrakRohitDivate) -> None:
        list_station = client.list_stations.list_stations(
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_list_stations(self, client: AmtrakRohitDivate) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_list_stations(self, client: AmtrakRohitDivate) -> None:
...
class TestAsyncListStations:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_list_stations(self, async_client: AsyncAmtrakRohitDivate) -> None:
        list_station = await async_client.list_stations.list_stations()
        assert_matches_type(ListStationListStationsResponse, list_station, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_method_list_stations_with_all_params(self, async_client: AsyncAmtrakRohitDivate) -> None:
        list_station = await async_client.list_stations.list_stations(
            coordinates="coordinates",
            country="country",
            limit=1,
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_list_stations(self, async_client: AsyncAmtrakRohitDivate) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_list_stations(self, async_client: AsyncAmtrakRohitDivate) -> None:
